...
echo " Welcome! Dear Manhan Burn!!<br><br>";

// Performing SQL query

$query ="select patientnumber, firstname, lastname, sex, address, cdtnname from patient p, cdtn c where p.firstname='Manhan' and p.lastname='Burn' and p.cdtntype=c.cdtntype";
...
$query1 ="select croomnumber, d.firstname, d.lastname, date, time from appointment ap, patient p, doctor d where ap.patientnumber=p.patientnumber and ap.staffnumber=d.staffnumber and p.firstname='Manhan' and p.lastname='Burn'";
