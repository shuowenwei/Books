...
echo " Welcome! Dear Michell White!!<br><br>";

// Performing SQL query

$query ="select staffnumber, firstname, lastname, sex, cdtnname from doctor d, cdtn c where d.firstname='Michell' and d.lastname='White' and d.cdtntype=c.cdtntype;";
...
$query1 ="select croomnumber, c.cdtnname, p.firstname, p.lastname, p.sex, date, time from appointment ap, patient p, doctor d, cdtn c where ap.patientnumber=p.patientnumber and ap.staffnumber=d.staffnumber and d.firstname='Michell' and d.lastname='White' and c.cdtntype=p.cdtntype";
