...
if (isset($_POST['staffnumber'])) {
	...
	$query6="select d.firstname, d.lastname, c.cdtnname from doctor d, patient p, cdtn c where staffnumber='".$staffnumber."' and p.patientnumber='".$patientnumber."' and c.cdtntype=p.cdtntype";
	$result6 = mysql_query($query6);
	$line6 = mysql_fetch_array($result6, MYSQL_ASSOC);
	...
	else
	{
		...
		else
		{
			...
			{
				echo "<br>Dr. ".$line6["firstname"]." ".$line6["lastname"]." (with Doctor ID: ".$staffnumber." you just chose) doesn't treat your condition ".$line6["cdtnname"]." or the consulting room ".$croomnumber." is not used for your condition ".$line6["cdtnname"].".<br><br>Please reture to the previous page and input the correct information.<br>";
				exit();
			}
			else
			{
