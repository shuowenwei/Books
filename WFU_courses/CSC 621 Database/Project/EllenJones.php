...
echo " Welcome! Dear Ellen Jones!!<br><br>";

// Performing SQL query

$query ="select patientnumber, firstname, lastname, sex, address, cdtnname from patient p, cdtn c where p.firstname='Ellen' and p.lastname='Jones' and p.cdtntype=c.cdtntype";
...
$query1 ="select croomnumber, d.firstname, d.lastname, date, time from appointment ap, patient p, doctor d where ap.patientnumber=p.patientnumber and ap.staffnumber=d.staffnumber and p.firstname='Ellen' and p.lastname='Jones'";
...
////<td>".<input type="buttom" name="submit" value="Cancel"/>."
...
//echo "<br><a href='http://10.104.250.237/cancelapp.php?patientnumber=p101'>Cancel your appointments</a><br>";
